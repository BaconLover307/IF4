...
public class Car {
	...
	public int getAcPower() {return this.ac_power;}
	...
	*/
	public void fillingFuel(Fuel t_fuel, int amount_in_liter) throws Exception {
	...
	*/
	public void changeGear(int t_gear) throws Exception {
        if ((t_gear < MIN_GEAR) || (MAX_GEAR < t_gear)) {
	...
	*/
	public void changeAcPower(int t_ac_power) throws Exception {
        if (t_ac_power < MIN_AC || MAX_AC < t_ac_power) {
