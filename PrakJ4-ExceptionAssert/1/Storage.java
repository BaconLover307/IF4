...
public class Storage {
  ...
  public void addContent(final String product, int quantity) throws Exception{
    ...
    // ...
    if (getQuantity() + quantity > capacity) throw new InsufficientStorageException(product, quantity);
  ...
  public void pullContent(String product, int quantity) throws Exception {
    ...
    // ...
    if (!storage.containsKey(product)) throw new NonExistProductException(product);
    ...
    // ...
    if (storage.get(product) < quantity) throw new InsufficientProductException(product, storage.get(product),quantity);
