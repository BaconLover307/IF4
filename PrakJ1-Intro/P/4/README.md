...
* method compareTo(Mahasiswa m) yang membandingkan dua mahasiswa.
  * Mahasiswa A disebut kurang dari mahasiswa B bila:
    ...
    * kode jurusan mahasiswa A sama dengan mahasiswa B, tapi angkatannya leb    * muda (bilangannya lebih besar)
    * kode jurusan dan angkatan mahasiswa A sama dengan mahasiswa B, tapi ipk nya lebih besar
  * Mahasiswa A sama dengan mahasiswa B bila kode jurusan, angkatan, dan ip  * kedua mahasiswa bernilai sama
